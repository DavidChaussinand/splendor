...
def test_game_should_start(game_repo, game_start, number_of_player, token_number, noble_number):
    ...
    expected = Board(yellow=5, red=token_number, green=token_number, white=token_number, blue=token_number, black=token_number, noble_number=noble_number, card_level1=4, card_level2=4, card_level3=4)
